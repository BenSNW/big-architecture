...
public class HMM {
    ...
    public static void main(String argv[]) {
        ...
        System.out.println(Arrays.deepToString(hmm.forwardProc(new int[] {0, 0, 0})));

        int[] observations = Stream.of("0112211100000000220011120000001211102010222002012201122200112200220010120000202011010001211202022001".split(""))
    ...
    /** emission probabilities: b[i][j] = P(observation j | state i) */
    public double b[][];
     ...
     * output sequence O with the current HMM parameters
     ...
     * for output sequence O with the current HMM parameters
     *
     * @param o the output sequence O
